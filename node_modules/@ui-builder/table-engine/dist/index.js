...
function Table({
  ...
  const [localSortConfig, setLocalSortConfig] = (0, import_react4.useState)(null);
  const [localFilterConfig, setLocalFilterConfig] = (0, import_react4.useState)(null);
  ...
  const Row = ({ index, style }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableRow, { style, children: columns.map((column2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { width: column2.width, children: column2.render ? column2.render(item) : String(item[column2.dataIndex]) }, column2.key)) });
  };
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableWrapper, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, { children: columns.map((column2) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      HeaderCell,
      {
        width: column2.width,
        ...
        children: [
          column2.title,
          column2.sortable && sortConfig?.key === column2.key && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SortIcon, { className: sortConfig.direction }),
          column2.filterable && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            FilterInput,
            {
              type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    paginationConfig && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Pagination, { children: [
